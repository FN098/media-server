...
import { useTrashDialogs } from "@/feature/pages/trash/hooks/use-trash-dialogs";
import { useTrashFiltering } from "@/feature/pages/trash/hooks/use-trash-filtering";
import { useTrashHotkeys } from "@/feature/pages/trash/hooks/use-trash-hotkeys";
import { useTrashMenu } from "@/feature/pages/trash/hooks/use-trash-menu";
import { useTrashNavigation } from "@/feature/pages/trash/hooks/use-trash-navigation";
import { useTrashSelectionBar } from "@/feature/pages/trash/hooks/use-trash-selection-bar";
import { useTrashThumbs } from "@/feature/pages/trash/hooks/use-trash-thumbs";
